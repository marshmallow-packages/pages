...
class LayoutCommand extends Command
{
    ...
    public function handle()
    {
    	...
    	$name_examle = $slug;
    	$class_examle = (strpos($upper_camel, 'Layout') === false) ? $upper_camel . 'Layout' : $upper_camel;
    	$component_example = (strpos($upper_camel, 'Component') === false) ? $upper_camel . 'Component' : $upper_camel;
        ...
        if ($this->option('empty')) {
            $this->fields = '';
            $this->use = 'use \Marshmallow\Pages\Flexible\Layouts\Traits;';
        }
